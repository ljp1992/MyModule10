odoo.define('add_button_in_tree_view.add_tree_view_button', function (require) {
    ...
    var show_button_model = [{'show_model': 'sale.order', 'wiard_model': 'import.quotation'},];//哪些模型显示导入按钮
    ...
    ListView.include({
        render_buttons: function () {
            ...
            for(var i=0; i<show_button_model.length; i++) {
                if (tree_model == show_button_model[i]['show_model']){
                    this.wiard_model = show_button_model[i]['wiard_model'];
